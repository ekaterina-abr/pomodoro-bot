import { AddressInput, InputIdentityDocumentInput, InputPersonalDocumentInput, PersonalDetailsInput } from './index';
/** Contains information about a Telegram Passport element to be saved */
export declare type InputPassportElementInputUnion = InputPassportElementPersonalDetailsInput | InputPassportElementPassportInput | InputPassportElementDriverLicenseInput | InputPassportElementIdentityCardInput | InputPassportElementInternalPassportInput | InputPassportElementAddressInput | InputPassportElementUtilityBillInput | InputPassportElementBankStatementInput | InputPassportElementRentalAgreementInput | InputPassportElementPassportRegistrationInput | InputPassportElementTemporaryRegistrationInput | InputPassportElementPhoneNumberInput | InputPassportElementEmailAddressInput;
