...
export declare type PassportElementTypeInputUnion = PassportElementTypePersonalDetailsInput | PassportElementTypePassportInput | PassportElementTypeDriverLicenseInput | PassportElementTypeIdentityCardInput | PassportElementTypeInternalPassportInput | PassportElementTypeAddressInput | PassportElementTypeUtilityBillInput | PassportElementTypeBankStatementInput | PassportElementTypeRentalAgreementInput | PassportElementTypePassportRegistrationInput | PassportElementTypeTemporaryRegistrationInput | PassportElementTypePhoneNumberInput | PassportElementTypeEmailAddressInput;
