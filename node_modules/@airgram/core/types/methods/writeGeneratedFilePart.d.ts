 ...
 */
export declare type writeGeneratedFilePart = (params?: WriteGeneratedFilePartParams, options?: ApiRequestOptions) => Promise<ApiResponse<WriteGeneratedFilePartParams, OkUnion>>;
