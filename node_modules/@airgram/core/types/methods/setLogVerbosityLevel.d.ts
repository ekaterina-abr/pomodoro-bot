 ...
 */
export declare type setLogVerbosityLevel = (params?: SetLogVerbosityLevelParams, options?: ApiRequestOptions) => Promise<ApiResponse<SetLogVerbosityLevelParams, OkUnion>>;
export declare type setLogVerbosityLevelSync = (params?: SetLogVerbosityLevelParams) => OkUnion;
