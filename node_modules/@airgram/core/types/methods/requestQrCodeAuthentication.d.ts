 ...
 */
export declare type requestQrCodeAuthentication = (params?: RequestQrCodeAuthenticationParams, options?: ApiRequestOptions) => Promise<ApiResponse<RequestQrCodeAuthenticationParams, OkUnion>>;
