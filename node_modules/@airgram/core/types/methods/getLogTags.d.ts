 ...
 */
export declare type getLogTags = (params?: never, options?: ApiRequestOptions) => Promise<ApiResponse<never, LogTagsUnion>>;
export declare type getLogTagsSync = (params?: never) => LogTagsUnion;
