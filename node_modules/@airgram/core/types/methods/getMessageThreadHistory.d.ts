 ...
 */
export declare type getMessageThreadHistory = (params?: GetMessageThreadHistoryParams, options?: ApiRequestOptions) => Promise<ApiResponse<GetMessageThreadHistoryParams, MessagesUnion>>;
