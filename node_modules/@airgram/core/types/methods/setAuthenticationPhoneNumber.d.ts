 ...
 */
export declare type setAuthenticationPhoneNumber = (params?: SetAuthenticationPhoneNumberParams, options?: ApiRequestOptions) => Promise<ApiResponse<SetAuthenticationPhoneNumberParams, OkUnion>>;
