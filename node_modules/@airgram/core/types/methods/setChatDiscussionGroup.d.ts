 ...
 * to find all suitable groups. Basic group chats need to be first upgraded to supergroup
 ...
 */
export declare type setChatDiscussionGroup = (params?: SetChatDiscussionGroupParams, options?: ApiRequestOptions) => Promise<ApiResponse<SetChatDiscussionGroupParams, OkUnion>>;
