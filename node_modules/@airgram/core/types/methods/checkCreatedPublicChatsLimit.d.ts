 ...
 */
export declare type checkCreatedPublicChatsLimit = (params?: CheckCreatedPublicChatsLimitParams, options?: ApiRequestOptions) => Promise<ApiResponse<CheckCreatedPublicChatsLimitParams, OkUnion>>;
