import { CallDiscardReasonUnion, CallProtocol, CallServer, Error } from './index';
/** Describes the current call state */
export declare type CallStateUnion = CallStatePending | CallStateExchangingKeys | CallStateReady | CallStateHangingUp | CallStateDiscarded | CallStateError;
