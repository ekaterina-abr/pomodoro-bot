 ...
 * to the user
 */
export declare type AuthenticationCodeTypeUnion = AuthenticationCodeTypeTelegramMessage | AuthenticationCodeTypeSms | AuthenticationCodeTypeCall | AuthenticationCodeTypeFlashCall;
/**
