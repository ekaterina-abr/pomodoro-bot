import { Address, AuthorizationStateUnion, Background, BasicGroup, BasicGroupFullInfo, Call, CallbackQueryPayloadUnion, Chat, ChatActionBarUnion, ChatActionUnion, ChatFilterInfo, ChatListUnion, ChatNearby, ChatNotificationSettings, ChatPermissions, ChatPhotoInfo, ChatPosition, ConnectionStateUnion, DraftMessage, File, LanguagePackString, Location, Message, MessageContentUnion, MessageInteractionInfo, Notification, NotificationGroup, NotificationGroupTypeUnion, NotificationSettingsScopeUnion, OptionValueUnion, OrderInfo, Poll, ReplyMarkupUnion, ScopeNotificationSettings, SecretChat, StickerSet, StickerSets, SuggestedActionUnion, Supergroup, SupergroupFullInfo, TermsOfService, User, UserFullInfo, UserPrivacySettingRules, UserPrivacySettingUnion, UserStatusUnion } from './index';
/** Contains notifications about data changes */
export declare type UpdateUnion = UpdateAuthorizationState | UpdateNewMessage | UpdateMessageSendAcknowledged | UpdateMessageSendSucceeded | UpdateMessageSendFailed | UpdateMessageContent | UpdateMessageEdited | UpdateMessageInteractionInfo | UpdateMessageContentOpened | UpdateMessageMentionRead | UpdateMessageLiveLocationViewed | UpdateNewChat | UpdateChatTitle | UpdateChatPhoto | UpdateChatPermissions | UpdateChatLastMessage | UpdateChatPosition | UpdateChatIsMarkedAsUnread | UpdateChatIsBlocked | UpdateChatHasScheduledMessages | UpdateChatDefaultDisableNotification | UpdateChatReadInbox | UpdateChatReadOutbox | UpdateChatUnreadMentionCount | UpdateChatNotificationSettings | UpdateScopeNotificationSettings | UpdateChatActionBar | UpdateChatPinnedMessage | UpdateChatReplyMarkup | UpdateChatDraftMessage | UpdateChatFilters | UpdateChatOnlineMemberCount | UpdateNotification | UpdateNotificationGroup | UpdateActiveNotifications | UpdateHavePendingNotifications | UpdateDeleteMessages | UpdateUserChatAction | UpdateUserStatus | UpdateUser | UpdateBasicGroup | UpdateSupergroup | UpdateSecretChat | UpdateUserFullInfo | UpdateBasicGroupFullInfo | UpdateSupergroupFullInfo | UpdateServiceNotification | UpdateFile | UpdateFileGenerationStart | UpdateFileGenerationStop | UpdateCall | UpdateNewCallSignalingData | UpdateUserPrivacySettingRules | UpdateUnreadMessageCount | UpdateUnreadChatCount | UpdateOption | UpdateStickerSet | UpdateInstalledStickerSets | UpdateTrendingStickerSets | UpdateRecentStickers | UpdateFavoriteStickers | UpdateSavedAnimations | UpdateSelectedBackground | UpdateLanguagePackStrings | UpdateConnectionState | UpdateTermsOfService | UpdateUsersNearby | UpdateDiceEmojis | UpdateAnimationSearchParameters | UpdateSuggestedActions | UpdateNewInlineQuery | UpdateNewChosenInlineResult | UpdateNewCallbackQuery | UpdateNewInlineCallbackQuery | UpdateNewShippingQuery | UpdateNewPreCheckoutQuery | UpdateNewCustomEvent | UpdateNewCustomQuery | UpdatePoll | UpdatePollAnswer;
