import { ChatLocation, ChatMemberStatusUnion, ChatPermissions, ChatPhoto, Message } from './index';
/** Represents a chat event */
export declare type ChatEventActionUnion = ChatEventMessageEdited | ChatEventMessageDeleted | ChatEventPollStopped | ChatEventMessagePinned | ChatEventMessageUnpinned | ChatEventMemberJoined | ChatEventMemberLeft | ChatEventMemberInvited | ChatEventMemberPromoted | ChatEventMemberRestricted | ChatEventTitleChanged | ChatEventPermissionsChanged | ChatEventDescriptionChanged | ChatEventUsernameChanged | ChatEventPhotoChanged | ChatEventInvitesToggled | ChatEventLinkedChatChanged | ChatEventSlowModeDelayChanged | ChatEventSignMessagesToggled | ChatEventStickerSetChanged | ChatEventLocationChanged | ChatEventIsAllHistoryAvailableToggled;
