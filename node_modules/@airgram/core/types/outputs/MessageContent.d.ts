import { Animation, Audio, CallDiscardReasonUnion, ChatPhoto, Contact, Document, EncryptedCredentials, EncryptedPassportElement, FormattedText, Game, Location, OrderInfo, PassportElementTypeUnion, Photo, Poll, Sticker, Venue, Video, VideoNote, VoiceNote, WebPage } from './index';
