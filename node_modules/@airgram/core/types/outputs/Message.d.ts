import { MessageContentUnion, MessageForwardInfo, MessageInteractionInfo, MessageSchedulingStateUnion, MessageSendingStateUnion, ReplyMarkupUnion } from './index';
export declare type MessageUnion = Message;
/** Describes a message */
